...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CABLE_LENGTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "CRC_POLY" -parent ${Page_0}
  ipgui::add_param $IPINST -name "CRC_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "ERROR_INJ" -parent ${Page_0}
  ipgui::add_param $IPINST -name "ERROR_SEED" -parent ${Page_0}
